...
ops = [cirq.Z(qubits[0]), cirq.Z(qubits[1]), cirq.X(qubits[2]), cirq.X(qubits[3])]
observables = [ops[0]*ops[1], ops[2]*ops[3]]
rescaling_type = LocalExpectationRescaling
state_dim = 4
pqc = FullEncodingMultiQubitUniversalQuantumClassifier

# Parameters for the training
gamma = 0.99
num_episodes = 1000
max_memory_length = 50000 # Maximum replay length
