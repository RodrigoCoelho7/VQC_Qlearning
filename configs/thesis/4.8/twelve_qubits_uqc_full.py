...
ops = [cirq.Z(qubits[0]), cirq.Z(qubits[1]), cirq.Z(qubits[2]), cirq.Z(qubits[3]), cirq.Z(qubits[4]), cirq.Z(qubits[5]), cirq.Z(qubits[6]), cirq.Z(qubits[7]), cirq.Z(qubits[8]), cirq.Z(qubits[9]), cirq.Z(qubits[10]), cirq.Z(qubits[11])]
observables = [ops[0]* ops[1] * ops[2]* ops[3] * ops[4] * ops[5] , ops[6]* ops[7]* ops[8]* ops[9]*ops[10]*ops[11]]
